            ...
            <div className="w-full max-w-5xl h-[95vh] bg-white rounded-[2rem] shadow-2xl flex overflow-hidden border border-gray-200">
                ...
                <div className="w-full lg:w-1/2 p-6 lg:p-10 flex flex-col justify-center overflow-y-auto">
                    ...
                    <Link href="/" className="flex items-center mb-4 w-fit">
                        <Image src="/desk-top.png" alt="ilagbilghiza" width={160} height={48} className="w-auto h-9 object-contain" priority />
                    </Link>

                    <h1 className="text-2xl font-black text-gray-900 mb-1">Create your account</h1>
                    <p className="text-gray-500 text-xs mb-4">
                        Join now to manage your health, nutrition and expert care.
                    </p>
                    ...
                    <div className="mt-3 flex flex-row gap-3">
                        <button type="button" className="flex-1 flex items-center justify-center gap-2 py-2 border border-gray-300 rounded-xl text-xs font-medium text-gray-700 hover:bg-gray-50 transition-colors">
                        ...
                        <button type="button" className="flex-1 flex items-center justify-center gap-2 py-2 border border-gray-300 rounded-xl text-xs font-medium text-gray-700 hover:bg-gray-50 transition-colors">
                            <Apple size={15} className="text-black" />
                            Apple
                        </button>
                    </div>
                ...
                <div className="hidden lg:flex lg:w-1/2 bg-[#214a32] p-8 flex-col justify-center relative bg-[url('https://www.transparenttextures.com/patterns/cubes.png')] bg-blend-soft-light">
                    ...
                    <div className="absolute bottom-8 left-16 right-16 pt-6 border-t border-white/10 z-10 flex flex-col items-center lg:items-start">
                        <p className="text-[10px] font-bold text-white/50 tracking-[0.15em] uppercase mb-4 text-center lg:text-left">
                            Developer
                        </p>
                        <div className="flex items-center justify-center gap-4 text-white/80 w-max bg-white/5 backdrop-blur-md px-6 py-2 rounded-xl border border-white/10 shadow-xl group hover:bg-white/10 transition-all duration-300">
                             <span className="text-white font-black text-xl tracking-tighter italic drop-shadow-lg scale-100 group-hover:scale-105 transition-transform duration-300">Saif</span>
                        </div>
                    </div>
                </div>
            </div>
