...
export default function LoginPage() {
    ...
    return (
        <div className="min-h-screen bg-gray-100 flex items-center justify-center p-4 sm:p-6 lg:p-8">
            <div className="w-full max-w-6xl bg-white rounded-[2rem] shadow-2xl flex overflow-hidden min-h-[750px] max-h-[95vh] border border-gray-200">

                <div className="w-full lg:w-1/2 p-10 sm:p-12 lg:p-20 flex flex-col justify-center h-full max-h-full overflow-y-auto relative">
                    {/* Logo */}
                    ...
                    <div className="mt-8 flex flex-col gap-3">
                        <button type="button" className="flex items-center justify-center gap-3 w-full py-3 border border-gray-300 rounded-xl text-sm font-medium text-gray-700 hover:bg-gray-50 transition-colors">
