...
>>>>>>> 87b965e (initial commit)
                ...
                <div className="md:col-span-6 lg:col-span-3">
                    <h3 className="text-[#22aa4f] font-black uppercase tracking-[0.2em] text-[10px] mb-6 md:mb-10">Quick Navigation</h3>
                ...
                <div className="md:col-span-6 lg:col-span-4">
                    <h3 className="text-[#22aa4f] font-black uppercase tracking-[0.2em] text-[10px] mb-6 md:mb-10">Contact Support</h3>
                    <ul className="space-y-4 md:space-y-6">
                        <li className="flex items-start gap-4">
                            <div className="size-9 rounded-xl bg-white/5 flex items-center justify-center shrink-0 border border-white/5">
                                <MapPin size={16} className="text-[#22aa4f]" />
                            </div>
                            <div>
                        ...
                        <li className="flex items-start gap-4">
                            <div className="size-9 rounded-xl bg-white/5 flex items-center justify-center shrink-0 border border-white/5">
                                <Phone size={16} className="text-[#22aa4f]" />
                            </div>
                            <div>
                        ...
                        <li className="flex items-start gap-4">
                            <div className="size-9 rounded-xl bg-white/5 flex items-center justify-center shrink-0 border border-white/5">
                                <Mail size={16} className="text-[#22aa4f]" />
                            </div>
                            <div>
