  ...
  return (
    <section className="bg-white py-24 px-6 relative overflow-hidden">
      ...
      <div className="text-center mb-16 relative z-10">
        <span className="bg-[#f4f5ee] text-[#22aa4f] font-black uppercase tracking-[0.4em] text-[10px] px-4 py-1.5 rounded-full border border-[#f4f5ee] shadow-sm mb-4 inline-block">
          Our Benefits
        </span>
        <h2 className="text-4xl md:text-5xl font-black text-[#21492f] uppercase tracking-tighter">
          ...
          {features.filter(f => f.side === 'left').map((feature, idx) => (
            ...
            >
              <div className="flex-1 order-2 lg:order-1">
                <h3 className="text-lg md:text-xl font-black text-[#21492f] uppercase tracking-tight mb-2 group-hover:text-[#22aa4f] transition-colors">{feature.title}</h3>
